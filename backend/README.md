...
Phase 6 versions the six-table schema with Alembic and verifies upgrade/downgrade behavior against
PostgreSQL. Seed data remains intentionally deferred to Phase 7.
